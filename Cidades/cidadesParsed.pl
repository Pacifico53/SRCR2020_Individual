...
cidade(17.0, 'Santarem', 39.233333, -8.683333, 'Santarem', 'admin').
cidade(18.0, 'Viseu', 40.661014, -7.909714, 'Viseu', 'admin').
cidade(19.0, 'Covilha', 40.286011, -7.503961, 'Castelo Branco', 'minor').
...
cidade(27.0, 'Sao Joao da Pesqueira', 41.148051, -7.404888, 'Viseu', 'minor').
cidade(28.0, 'Sao Joao da Madeira', 40.900956, -8.499744, 'Aveiro', 'minor').
...
cidade(31.0, 'Portel', 38.30697, -7.702435, 'Evora', 'minor').
cidade(32.0, 'Porto', 41.149606, -8.610993, 'Porto', 'admin').
cidade(33.0, 'Serta', 39.808461, -8.098829, 'Castelo Branco', 'minor').
cidade(34.0, 'Vila do Bispo', 37.083172, -8.911438, 'Faro', 'minor').
cidade(35.0, 'Fronteira', 39.056291, -7.648679, 'Portalegre', 'minor').
cidade(36.0, 'Alfandega da Fe', 41.343149, -6.961124, 'Braganca', 'minor').
...
cidade(41.0, 'Tabuaco', 41.116147, -7.567934, 'Viseu', 'minor').
...
cidade(47.0, 'Rio Maior', 39.337325, -8.939063, 'Santarem', 'minor').
cidade(48.0, 'Condeixa-a-Nova', 40.115733, -8.498336, 'Coimbra', 'minor').
cidade(49.0, 'Macao', 39.555734, -7.994215, 'Santarem', 'minor').
...
cidade(53.0, 'Moita', 38.650779, -8.990383, 'Setubal', 'minor').
cidade(54.0, 'Ponte de Lima', 41.767188, -8.583926, 'Viana do Castelo', 'minor').
cidade(55.0, 'Guimaraes', 41.444435, -8.296189, 'Braga', 'minor').
cidade(56.0, 'Sobral de Monte Agraco', 39.019579, -9.150809, 'Lisboa', 'minor').
cidade(57.0, 'Seixal', 38.64008, -9.101412, 'Setubal', 'minor').
cidade(58.0, 'Almeirim', 39.209028, -8.616426, 'Santarem', 'minor').
...
cidade(62.0, 'Golega', 39.40474, -8.48625, 'Santarem', 'minor').
...
cidade(66.0, 'Agueda', 40.577205, -8.444418, 'Aveiro', 'minor').
...
cidade(70.0, 'Sardoal', 39.535994, -8.161413, 'Santarem', 'minor').
cidade(71.0, 'Vila do Conde', 41.354811, -8.743397, 'Porto', 'minor').
cidade(72.0, 'Alijo', 41.276781, -7.474883, 'Vila Real', 'minor').
...
cidade(76.0, 'Castanheira de Pera', 40.007169, -8.210484, 'Leiria', 'minor').
cidade(77.0, 'Melgaco', 42.113371, -8.260161, 'Viana do Castelo', 'minor').
cidade(78.0, 'Gaviao', 39.464431, -7.934494, 'Portalegre', 'minor').
cidade(79.0, 'Monforte', 39.053297, -7.437582, 'Portalegre', 'minor').
cidade(80.0, 'Vila Vicosa', 38.777696, -7.417927, 'Evora', 'minor').
cidade(81.0, 'Almodovar', 37.512792, -8.060077, 'Beja', 'minor').
cidade(82.0, 'Redondo', 38.648716, -7.547082, 'Evora', 'minor').
...
cidade(85.0, 'Lousa', 40.111911, -8.24703, 'Coimbra', 'minor').
cidade(86.0, 'Amadora', 38.759711, -9.239708, 'Lisboa', 'minor').
cidade(87.0, 'Pinhel', 40.774029, -7.06675, 'Guarda', 'minor').
cidade(88.0, 'Estremoz', 38.844316, -7.585854, 'Evora', 'minor').
...
cidade(95.0, 'Alcochete', 38.755335, -8.960861, 'Setubal', 'minor').
cidade(96.0, 'Sever do Vouga', 40.734588, -8.367219, 'Aveiro', 'minor').
cidade(97.0, 'Sesimbra', 38.444513, -9.101236, 'Setubal', 'minor').
cidade(98.0, 'Sao Pedro do Sul', 40.75537, -8.072646, 'Viseu', 'minor').
cidade(99.0, 'Lourinha', 39.233333, -9.316667, 'Lisboa', 'minor').
cidade(100.0, 'Santa Comba Dao', 40.398559, -8.131601, 'Viseu', 'minor').
cidade(101.0, 'Entroncamento', 39.466667, -8.466667, 'Santarem', 'minor').
...
cidade(104.0, 'Pacos de Ferreira', 41.276571, -8.376174, 'Porto', 'minor').
cidade(105.0, 'Fafe', 41.454227, -8.167998, 'Braga', 'minor').
cidade(106.0, 'Ponte de Sor', 39.249642, -8.010086, 'Portalegre', 'minor').
cidade(107.0, 'Moimenta da Beira', 40.983828, -7.617653, 'Viseu', 'minor').
cidade(108.0, 'Santa Marta de Penaguiao', 41.211161, -7.800111, 'Vila Real', 'minor').
cidade(109.0, 'Murca', 41.405997, -7.454846, 'Vila Real', 'minor').
cidade(110.0, 'Sernancelhe', 40.898706, -7.493419, 'Viseu', 'minor').
cidade(111.0, 'Vila Real', 41.30062, -7.744129, 'Vila Real', 'admin').
cidade(112.0, 'Vinhais', 41.835094, -7.005007, 'Braganca', 'minor').
cidade(113.0, 'Alcacer do Sal', 38.373258, -8.514436, 'Setubal', 'minor').
cidade(114.0, 'Ourem', 39.641675, -8.591899, 'Santarem', 'minor').
...
cidade(117.0, 'Vila Nova da Barquinha', 39.45, -8.433333, 'Santarem', 'minor').
cidade(118.0, 'Loule', 37.137722, -8.019684, 'Faro', 'minor').
cidade(119.0, 'Lamego', 41.097407, -7.809907, 'Viseu', 'minor').
cidade(120.0, 'Alvaiazere', 39.822559, -8.379994, 'Leiria', 'minor').
cidade(121.0, 'Satao', 40.741775, -7.732855, 'Viseu', 'minor').
cidade(122.0, 'Albergaria-a-Velha', 40.693185, -8.479936, 'Aveiro', 'minor').
cidade(123.0, 'Matosinhos', 41.18207, -8.689076, 'Porto', 'minor').
cidade(124.0, 'Alandroal', 38.702005, -7.403094, 'Evora', 'minor').
cidade(125.0, 'Proenca-a-Nova', 39.752204, -7.923903, 'Castelo Branco', 'minor').
cidade(126.0, 'Lagoa', 37.135349, -8.453188, 'Faro', 'minor').
cidade(127.0, 'Montijo', 38.706747, -8.973885, 'Setubal', 'minor').
cidade(128.0, 'Felgueiras', 41.368058, -8.193961, 'Porto', 'minor').
cidade(129.0, 'Nazare', 39.602891, -9.068355, 'Leiria', 'minor').
...
cidade(133.0, 'Vila Flor', 41.309043, -7.153784, 'Braganca', 'minor').
cidade(134.0, 'Figueiro dos Vinhos', 39.904132, -8.275107, 'Leiria', 'minor').
cidade(135.0, 'Santiago do Cacem', 38.016935, -8.69475, 'Setubal', 'minor').
...
cidade(150.0, 'Vila Velha de Rodao', 39.666667, -7.7, 'Castelo Branco', 'minor').
cidade(151.0, 'Benavente', 38.979192, -8.807591, 'Santarem', 'minor').
...
cidade(157.0, 'Barreiro', 38.663137, -9.072395, 'Setubal', 'minor').
...
cidade(165.0, 'Viana do Alentejo', 38.33458, -8.004399, 'Evora', 'minor').
cidade(166.0, 'Carrazeda de Anciaes', 41.242466, -7.307206, 'Braganca', 'minor').
cidade(167.0, 'Ovar', 40.861753, -8.626014, 'Aveiro', 'minor').
cidade(168.0, 'Torres Novas', 39.481143, -8.539493, 'Santarem', 'minor').
cidade(169.0, 'Torres Vedras', 39.091089, -9.258602, 'Lisboa', 'minor').
cidade(170.0, 'Cartaxo', 39.160221, -8.787408, 'Santarem', 'minor').
...
cidade(175.0, 'Chamusca', 39.35722, -8.48151, 'Santarem', 'minor').
cidade(176.0, 'Trofa', 41.487817, -7.961286, 'Braga', 'minor').
cidade(177.0, 'Macedo de Cavaleiros', 41.538161, -6.9611, 'Braganca', 'minor').
cidade(178.0, 'Resende', 41.105822, -7.966497, 'Viseu', 'minor').
cidade(179.0, 'Povoa de Lanhoso', 41.577713, -8.268468, 'Braga', 'minor').
...
cidade(184.0, 'Alcanena', 39.459005, -8.668924, 'Santarem', 'minor').
cidade(185.0, 'Palmela', 38.569021, -8.901255, 'Setubal', 'minor').
cidade(186.0, 'Ferreira do Zezere', 39.694064, -8.292131, 'Santarem', 'minor').
cidade(187.0, 'Arouca', 40.930568, -8.24488, 'Aveiro', 'minor').
cidade(188.0, 'Vila de Rei', 39.67604, -8.145768, 'Castelo Branco', 'minor').
cidade(189.0, 'Tomar', 39.601987, -8.409242, 'Santarem', 'minor').
cidade(190.0, 'Tondela', 40.516815, -8.080866, 'Viseu', 'minor').
cidade(191.0, 'Constancia', 39.466667, -8.333333, 'Santarem', 'minor').
cidade(192.0, 'Vila Pouca de Aguiar', 41.500176, -7.64383, 'Vila Real', 'minor').
cidade(193.0, 'Almada', 38.679018, -9.156904, 'Setubal', 'minor').
...
cidade(198.0, 'Mertola', 37.643041, -7.661104, 'Beja', 'minor').
cidade(199.0, 'Mesao Frio', 41.163167, -7.873534, 'Vila Real', 'minor').
cidade(200.0, 'Mourao', 38.383562, -7.341888, 'Evora', 'minor').
cidade(201.0, 'Valpacos', 41.607461, -7.310876, 'Vila Real', 'minor').
cidade(202.0, 'Pombal', 39.916738, -8.628474, 'Leiria', 'minor').
cidade(203.0, 'Mogadouro', 41.340203, -6.711347, 'Braganca', 'minor').
cidade(204.0, 'Povoa de Varzim', 41.38344, -8.763637, 'Porto', 'minor').
cidade(205.0, 'Baiao', 41.162735, -8.034704, 'Porto', 'minor').
cidade(206.0, 'Mortagua', 40.396746, -8.232341, 'Viseu', 'minor').
cidade(207.0, 'Tabua', 40.362074, -8.02936, 'Coimbra', 'minor').
...
cidade(214.0, 'Freixo de Espada a Cinta', 41.090327, -6.806478, 'Braganca', 'minor').
cidade(215.0, 'Mora', 38.943515, -8.164337, 'Evora', 'minor').
cidade(216.0, 'Vendas Novas', 38.677056, -8.457924, 'Evora', 'minor').
cidade(217.0, 'Vila Nova de Foz Coa', 41.083333, -7.2, 'Guarda', 'minor').
cidade(218.0, 'Caldas da Rainha', 39.403255, -9.138387, 'Leiria', 'minor').
cidade(219.0, 'Marvao', 39.393912, -7.376861, 'Portalegre', 'minor').
cidade(220.0, 'Vimioso', 41.584726, -6.52767, 'Braganca', 'minor').
...
cidade(226.0, 'Coruche', 38.959546, -8.525235, 'Santarem', 'minor').
cidade(227.0, 'Coimbra', 40.205642, -8.419551, 'Coimbra', 'admin').
cidade(228.0, 'Barrancos', 38.134462, -6.976042, 'Beja', 'minor').
cidade(229.0, 'Montemor-o-Novo', 38.648117, -8.214549, 'Evora', 'minor').
cidade(230.0, 'Meda', 40.966352, -7.261634, 'Guarda', 'minor').
cidade(231.0, 'Obidos', 39.360551, -9.156696, 'Leiria', 'minor').
cidade(232.0, 'Gois', 40.157353, -8.110067, 'Coimbra', 'minor').
cidade(233.0, 'Reguengos de Monsaraz', 38.425293, -7.534945, 'Evora', 'minor').
cidade(234.0, 'Torre de Moncorvo', 41.174537, -7.05364, 'Braganca', 'minor').
cidade(235.0, 'Murtosa', 40.736948, -8.637697, 'Aveiro', 'minor').
cidade(236.0, 'Alcobaca', 39.552233, -8.977495, 'Leiria', 'minor').
...
cidade(239.0, 'Abrantes', 39.466667, -8.2, 'Santarem', 'minor').
cidade(240.0, 'Arruda dos Vinhos', 38.984106, -9.077463, 'Lisboa', 'minor').
cidade(241.0, 'Fundao', 40.140247, -7.501348, 'Castelo Branco', 'minor').
cidade(242.0, 'Tarouca', 41.014444, -7.781432, 'Viseu', 'minor').
cidade(243.0, 'Ilhavo', 40.599896, -8.667325, 'Aveiro', 'minor').
cidade(244.0, 'Alpiarca', 39.257116, -8.581866, 'Santarem', 'minor').
cidade(245.0, 'Albufeira', 37.090205, -8.25079, 'Faro', 'minor').
cidade(246.0, 'Penela', 40.033333, -8.383333, 'Coimbra', 'minor').
cidade(247.0, 'Valenca', 42.03104, -8.645953, 'Viana do Castelo', 'minor').
cidade(248.0, 'Amares', 41.630907, -8.351166, 'Braga', 'minor').
cidade(249.0, 'Sao Bras de Alportel', 37.1531, -7.887515, 'Faro', 'minor').
...
cidade(253.0, 'Alter do Chao', 39.198712, -7.658298, 'Portalegre', 'minor').
...
cidade(260.0, 'Cinfaes', 41.071969, -8.089991, 'Viseu', 'minor').
cidade(261.0, 'Borba', 38.80553, -7.45465, 'Evora', 'minor').
cidade(262.0, 'Mira', 40.428924, -8.737462, 'Coimbra', 'minor').
cidade(263.0, 'Silves', 37.189213, -8.438217, 'Faro', 'minor').
cidade(264.0, 'Grandola', 38.177181, -8.566746, 'Setubal', 'minor').
cidade(265.0, 'Campo Maior', 39.017742, -7.064967, 'Portalegre', 'minor').
cidade(266.0, 'Ferreira do Alentejo', 38.05, -8.033333, 'Beja', 'minor').
cidade(267.0, 'Miranda do Douro', 41.496921, -6.273077, 'Braganca', 'minor').
cidade(268.0, 'Mirandela', 41.487385, -7.186949, 'Braganca', 'minor').
cidade(269.0, 'Chaves', 41.740186, -7.468789, 'Vila Real', 'minor').
cidade(270.0, 'Sines', 37.956215, -8.869788, 'Setubal', 'minor').
cidade(271.0, 'Mondim de Basto', 41.411566, -7.954414, 'Vila Real', 'minor').
cidade(272.0, 'Moncao', 42.078471, -8.481452, 'Viana do Castelo', 'minor').
...
cidade(276.0, 'Olhao', 37.0286, -7.841101, 'Faro', 'minor').
cidade(277.0, 'Cadaval', 39.242977, -9.103271, 'Lisboa', 'minor').
cidade(278.0, 'Loures', 38.829082, -9.168106, 'Lisboa', 'minor').
cidade(279.0, 'Salvaterra de Magos', 39.027881, -8.793502, 'Santarem', 'minor').
cidade(280.0, 'Peso da Regua', 41.164912, -7.787034, 'Vila Real', 'minor').
cidade(281.0, 'Serpa', 37.945811, -7.597537, 'Beja', 'minor').
cidade(282.0, 'Sabugal', 40.351267, -7.091036, 'Guarda', 'minor').
cidade(283.0, 'Ansiao', 39.911774, -8.435683, 'Leiria', 'minor').
cidade(284.0, 'Vila Real de Santo Antonio', 37.194999, -7.417658, 'Faro', 'minor').
cidade(285.0, 'Porto de Mos', 39.601911, -8.818389, 'Leiria', 'minor').
